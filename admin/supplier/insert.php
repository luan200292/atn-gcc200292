...
<?php
        ...
        if(isset($_POST['Insert'])){
            $id = pg_escape_string($connect, $_POST['Supplier_id']);
            ...
            $checkpid = pg_query($connect, "SELECT supplier_id from supplier where supplier_id = '$id'");
            $rowpid = pg_fetch_row($checkpid);
            if($rowpid[0]!=$id){
            $insertQ = "INSERT INTO public.supplier (supplier_id, supplier_name, supplier_des, supplier_phone, supplier_email) 
                        VALUES ('$id','$SupplierName', '$des', '$phone', '$email')";
            ...
            // }
                ...
                echo "<script>alert('The Supplier ID has already exists! Please enter another ID!')</script>";
            }
        }
    ?>
<!-- div content -->
